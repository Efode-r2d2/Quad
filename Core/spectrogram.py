...
class Spectrogram(object):
    ...
    def __spectrogram(self, audio_data):
        """
    ...
    def __spectrogram_magnitude(self, audio_data):
        """
        ...
        """
        spectrogram = self.__spectrogram(audio_data)
        spectrogram_magnitude = np.abs(spectrogram)
        return spectrogram_magnitude

    def spectrogram_magnitude_in_db(self, audio_data):
        """
        ...
        """
        spectrogram_magnitude = self.__spectrogram_magnitude(audio_data)
